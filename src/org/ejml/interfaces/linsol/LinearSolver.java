 ...
 * <ol>
 * <li> Call {@link #setA(org.ejml.data.Matrix32F)}
 * <li> Call {@link #solve(org.ejml.data.Matrix32F, org.ejml.data.Matrix32F)}.
 * </ol>
 * </p>
 *
 * <p>
 ...
 * <ol>
 * <li> Call {@link #setA(org.ejml.data.Matrix32F)}
 * <li> Call {@link #invert(org.ejml.data.Matrix32F)}.
 * </ol>
 ...
 * @author Peter Abeles
 */
public interface LinearSolver< T extends Matrix32F> {
    ...
    /**
     * Computes the inverse of of the 'A' matrix passed into {@link #setA(org.ejml.data.Matrix32F)}
    ...
    /**
     * Returns true if the passed in matrix to {@link #setA(org.ejml.data.Matrix32F)}
     * is modified.
     *
    ...
    /**
     * Returns true if the passed in 'B' matrix to {@link #solve(org.ejml.data.Matrix32F, org.ejml.data.Matrix32F)}
     * is modified.
     *

 ...
 * @see org.ejml.alg.dense.decomposition.qr.QRDecompositionHouseholder_D32
 * @see org.ejml.alg.dense.decomposition.qr.QRDecompositionHouseholderColumn_D32
 *
 * @author Peter Abeles
 */
public interface QRDecomposition <T extends Matrix32F>
        extends DecompositionInterface<T> {
    /**
     * <p>
     * Returns the Q matrix from the decomposition.  Should only
     * be called after {@link #decompose(org.ejml.data.Matrix32F)} has
     * been called.
     * </p>
     *
     * <p>
     ...
     * called after {@link #decompose(org.ejml.data.Matrix32F)} has been.
     * </p>
     * <p>

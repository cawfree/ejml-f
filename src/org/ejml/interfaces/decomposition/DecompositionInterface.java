...
/**
 * <p>
 * An interface for performing matrix decompositions on a {@link org.ejml.data.DenseMatrix32F}.
 * </p>
 *
 * <p>
 ...
 * @author Peter Abeles
 */
public interface DecompositionInterface <T extends Matrix32F> {
    ...
    /**
     * Is the input matrix to {@link #decompose(org.ejml.data.Matrix32F)} is modified during

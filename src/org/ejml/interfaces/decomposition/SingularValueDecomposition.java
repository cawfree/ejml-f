 ...
 * The singular values can be put into descending order while adjusting U and V using {@link org.ejml.ops.SingularOps#descendingOrder(org.ejml.data.DenseMatrix32F, boolean, org.ejml.data.DenseMatrix32F, org.ejml.data.DenseMatrix32F, boolean)}  SingularOps.descendingOrder()}.
 * </p>
 *
 * @author Peter Abeles
 */
public abstract interface SingularValueDecomposition <T extends Matrix32F>
     ...
     * unnecessary float transpose the option is provided to select if the transpose is returned.
     * </p>
     *

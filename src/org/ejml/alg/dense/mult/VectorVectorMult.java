...
public class VectorVectorMult {
    ...
    // TODO have DenseMatrix32F flag itself as being a vector to make checks faster?
    public static void mult( DenseMatrix32F x , DenseMatrix32F y , DenseMatrix32F A )
    {
       // sanity check inputs
     ...
     */
    public static float innerProd( D1Matrix32F x, D1Matrix32F y )
    {
     ...
     * @return  The results.
     */
    public static float innerProdA( D1Matrix32F x, D1Matrix32F A , D1Matrix32F y )
    {
        int n = A.numRows;
        int m = A.numCols;
    ...
    public static float innerProdTranA( D1Matrix32F x, D1Matrix32F A , D1Matrix32F y )
    {
        int n = A.numRows;
     ...
     */
    public static void outerProd( D1Matrix32F x, D1Matrix32F y, RowD1Matrix32F A ) {
        int m = A.numRows;
        int n = A.numCols;
     ...
     * @param A A Matrix with m by n elements. Modified.
     */
    public static void addOuterProd( float gamma , D1Matrix32F x, D1Matrix32F y, RowD1Matrix32F A ) {
        int m = A.numRows;
        int n = A.numCols;
    ...
    public static void rank1Update( float gamma,
                                    DenseMatrix32F A ,
                                    DenseMatrix32F u , DenseMatrix32F w ,
                                    DenseMatrix32F B )
    {
        int n = u.getNumElements();

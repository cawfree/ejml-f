 ...
 * </p>
 *
 * @see org.ejml.alg.dense.decomposition.lu.LUDecompositionAlt_D32
 *
 * @author Peter Abeles
 */
public class DeterminantFromMinor {
    ...
    public DeterminantFromMinor( int width , int minWidth )
    {
        ...
        tempMat = new DenseMatrix32F(minWidth-1,minWidth-1);
    }
     ...
     */
    public float compute( RowD1Matrix32F mat ) {
...
//        System.arraycopy(mat.data,0,minorMatrix[0],0,mat.data.length);
    ...
    private void createMinor( RowD1Matrix32F mat ) {

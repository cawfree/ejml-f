...
/**
 * Wrapper that allows {@link org.ejml.interfaces.linsol.LinearSolver <BlockMatrix32F>} to implements {@link org.ejml.interfaces.linsol.LinearSolver}.  It works
 * by converting {@link DenseMatrix32F} into {@link BlockMatrix32F} and calling the equivalent
...
public class LinearSolver_B32_to_D32 implements LinearSolver<DenseMatrix32F> {
    protected LinearSolver<BlockMatrix32F> alg = new BlockCholeskyOuterSolver();
    ...
    public LinearSolver_B32_to_D32(LinearSolver<BlockMatrix32F> alg) {
        this.alg = alg;
    }

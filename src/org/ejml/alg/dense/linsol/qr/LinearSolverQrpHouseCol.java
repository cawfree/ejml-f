...
/**
 * <p>
 * Performs a pseudo inverse solver using the {@link org.ejml.alg.dense.decomposition.qr.QRColPivDecompositionHouseholderColumn_D32} decomposition
...
public class LinearSolverQrpHouseCol extends BaseLinearSolverQrp {
    ...
    private DenseMatrix32F x_basic = new DenseMatrix32F(1,1);

    public LinearSolverQrpHouseCol(QRColPivDecompositionHouseholderColumn_D32 decomposition,

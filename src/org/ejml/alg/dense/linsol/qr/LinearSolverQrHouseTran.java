...
import org.ejml.alg.dense.decomposition.qr.QRDecompositionHouseholderTran_D32;
...
public class LinearSolverQrHouseTran extends LinearSolverAbstract {
    ...
    private QRDecompositionHouseholderTran_D32 decomposer;
    ...
    private DenseMatrix32F QR; // a column major QR matrix
    ...
    public LinearSolverQrHouseTran() {
        decomposer = new QRDecompositionHouseholderTran_D32();
    }

...
public class LinearSolverQr extends LinearSolverAbstract {
    ...
    protected DenseMatrix32F Q;
    protected DenseMatrix32F R;

    private DenseMatrix32F Y,Z;

    /**
     * Creates a linear solver that uses QR decomposition.
     *
     */
    public LinearSolverQr( QRDecomposition<DenseMatrix32F> decomposer ) {
    ...
    public void setMaxSize( int maxRows , int maxCols )
    {
        ...
        Q = new DenseMatrix32F(maxRows,maxRows);
        R = new DenseMatrix32F(maxRows,maxCols);

        Y = new DenseMatrix32F(maxRows,1);
        Z = new DenseMatrix32F(maxRows,1);
    }

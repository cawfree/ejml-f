 ...
 * @see org.ejml.alg.dense.decomposition.hessenberg.TridiagonalDecompositionHouseholder_D32
 *
 * @author Peter Abeles
 */
public class SymmetricQRAlgorithmDecomposition_D32
    ...
    public SymmetricQRAlgorithmDecomposition_D32(TridiagonalSimilarDecomposition<DenseMatrix32F> decomp,
                                                 boolean computeVectors) {
    ...
    public SymmetricQRAlgorithmDecomposition_D32(boolean computeVectors) {
    ...
    public Complex32F getEigenvalue(int index) {
        return new Complex32F(values[index],0);
    }

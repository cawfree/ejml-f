...
public class SwitchingEigenDecomposition
    ...
    EigenDecomposition<DenseMatrix32F> symmetricAlg;
    EigenDecomposition<DenseMatrix32F> generalAlg;

    boolean symmetric;
    // should it compute eigenvectors or just eigenvalues?
    boolean computeVectors;

    DenseMatrix32F A = new DenseMatrix32F(1,1);
     ...
     */
    public SwitchingEigenDecomposition( int matrixSize , boolean computeVectors , float tol ) {

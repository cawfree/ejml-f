...
public class WatchedTwoStepQREigenvalue implements EigenvalueExtractor {
    ...
    WatchedTwoStepQREigen implicitQR;
    ...
    public WatchedTwoStepQREigenvalue() {
        implicitQR = new WatchedTwoStepQREigen();
    }
    ...
    @Override
    public boolean process(DenseMatrix32F origA) {
        setup(origA);
...
//                implicitQR.A.print();
    ...
    private void performIteration() {
        ...
        if( !changed )
            implicitQR.implicitFloatStep(x1,x2);
    }

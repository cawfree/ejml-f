...
public class HessenbergSimilarDecomposition_D32
        implements DecompositionInterface<DenseMatrix32F> {
     ...
     */
    public HessenbergSimilarDecomposition_D32(int initialSize) {
     ...
     */
    public DenseMatrix32F getH( DenseMatrix32F H ) {
        if( H == null ) {
            H = new DenseMatrix32F(N,N);
     ...
     */
    public DenseMatrix32F getQ( DenseMatrix32F Q ) {
        if( Q == null ) {

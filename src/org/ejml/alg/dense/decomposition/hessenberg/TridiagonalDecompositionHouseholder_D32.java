 ...
 * @author Peter Abeles
 */
public class TridiagonalDecompositionHouseholder_D32
    ...
    public TridiagonalDecompositionHouseholder_D32() {
        N = 1;
        w = new float[N];
        b = new float[N];
        gammas = new float[N];
    ...
    private void similarTransform( int k) {
        ...
        if( max > 0 ) {
            ...
            float tau = QrHelperFunctions.computeTauAndDivide(k,N,t,rowU,max);
     ...
     */
    public void init( DenseMatrix32F A ) {

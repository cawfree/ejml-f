 ...
 * code reuse it extends {@link QRDecompositionHouseholderColumn_D32} and functions from that class
 ...
 * @author Peter Abeles
 */
public class QRColPivDecompositionHouseholderColumn_D32
        extends QRDecompositionHouseholderColumn_D32
        implements QRPDecomposition<DenseMatrix32F>
{
    ...
    protected float singularThreshold = UtilEjml.EPS;
     ...
     */
    public QRColPivDecompositionHouseholderColumn_D32(float singularThreshold) {
    ...
    protected boolean householderPivot(int j)
    {
        ...
        final float max = QrHelperFunctions.findMax(u,j,numRows-j);
    ...
    @Override
    public DenseMatrix32F getPivotMatrix(DenseMatrix32F P) {
        if( P == null )
            P = new DenseMatrix32F(numCols,numCols);

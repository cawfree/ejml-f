...
//        }
     ...
     * </p>
     */
    public static void rank1UpdateMultR( DenseMatrix32F A , float u[] , float gamma ,
                                         int colA0,
                                         int w0, int w1 ,
                                         float _temp[] )
    {
...
//        }
    ...
    public static void rank1UpdateMultR(DenseMatrix32F A,
                                        float u[], int offsetU,
                                        float gamma,
                                        int colA0,
                                        int w0, int w1,
...
//        }
     ...
     * </p>
     */
    public static void rank1UpdateMultL( DenseMatrix32F A , float u[] ,
                                         float gamma ,
                                         int colA0,
                                         int w0 , int w1 )
    {

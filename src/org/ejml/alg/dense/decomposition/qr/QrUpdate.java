...
public class QrUpdate {
    ...
    private DenseMatrix32F Q,R;
    // product of planar multiplications
    private DenseMatrix32F U_tran; // using transpose of U reduces cache misses
    ...
    public void declareInternalData(int maxRows, int maxCols) {
        ...
        U_tran = new DenseMatrix32F(maxRows,maxRows);
        Qm = new DenseMatrix32F(maxRows,maxRows);
     ...
     */
    public void addRow( DenseMatrix32F Q , DenseMatrix32F R , float []row , int rowIndex , boolean resizeR ) {
     ...
     */
    public void deleteRow( DenseMatrix32F Q , DenseMatrix32F R , int rowIndex , boolean resizeR ) {
        setQR(Q,R,0);
        if( m - 1 < n ) {
     ...
     */
    private void setQR( DenseMatrix32F Q , DenseMatrix32F R , int growRows ) {

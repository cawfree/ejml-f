...
public class CholeskyDecompositionBlock_D32 extends CholeskyDecompositionCommon_D32 {
    ...
    private DenseMatrix32F B; // row rectangular matrix
     ...
     */
    public CholeskyDecompositionBlock_D32(int blockWidth) {
        super(true);
    ...
    public void setExpectedMaxSize( int numRows , int numCols ) {
        ...
        if( numRows < blockWidth)
            B = new DenseMatrix32F(0,0);
        else
            B = new DenseMatrix32F(blockWidth,maxWidth);

        chol = new CholeskyBlockHelper_D32(blockWidth);
    }
    ...
    public static void solveL_special( final float L[] ,
                                       final DenseMatrix32F b_src,
                                       final int indexSrc , final int indexDst ,
                                       final DenseMatrix32F B )
    {
...
//        }
     ...
     */
    public static void symmRankTranA_sub( DenseMatrix32F a , DenseMatrix32F c ,
                                          int startIndexC )
    {

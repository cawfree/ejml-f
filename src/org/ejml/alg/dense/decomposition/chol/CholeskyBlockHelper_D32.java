 ...
 * {@link CholeskyDecompositionBlock_D32} perform its calculations.  While decomposing
...
class CholeskyBlockHelper_D32 {
     ...
     */
    public CholeskyBlockHelper_D32(int widthMax) {

        this.L = new DenseMatrix32F(widthMax,widthMax);
        this.el = L.data;
    }
     ...
     */
    public boolean decompose( DenseMatrix32F mat , int indexStart , int n ) {
        float m[] = mat.data;

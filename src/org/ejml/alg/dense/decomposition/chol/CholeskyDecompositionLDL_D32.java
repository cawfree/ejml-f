 ...
 * @author Peter Abeles
 */
public class CholeskyDecompositionLDL_D32
        implements CholeskyLDLDecomposition<DenseMatrix32F> {
    ...
    public void setExpectedMaxSize( int numRows , int numCols ) {
        ...
        this.L = new DenseMatrix32F(maxWidth,maxWidth);
        this.el = L.data;
    ...
    @Override
    public DenseMatrix32F getL(DenseMatrix32F L) {
        if( L == null ) {
            L = this.L.copy();
        } else {
            L.set(this.L);
    ...
    @Override
    public DenseMatrix32F getD(DenseMatrix32F D) {

...
//    public static DenseD2Matrix64F convertToD2( DenseMatrix32F orig ) {
...
//    }
    ...
    public static boolean isEquivalent( ReshapeMatrix32F a , ReshapeMatrix32F b , float tol )
    {
     ...
     */
    public static boolean isIdentity( ReshapeMatrix32F a , float tol )
    {
        for( int i = 0; i < a.numRows; i++ ) {
            for( int j = 0; j < a.numCols; j++ ) {
                if( i == j ) {
    ...
    public static boolean isEquivalentTriangle( boolean upper , ReshapeMatrix32F a , ReshapeMatrix32F b , float tol )
    {
        if( a.numRows != b.numRows || a.numCols != b.numCols )
            return false;
    ...
    public static void copy( ReshapeMatrix32F from , ReshapeMatrix32F to )
    {
    ...
    public static void setRandom( ReshapeMatrix32F a , float min , float max , Random rand )
    {
        for( int i = 0; i < a.numRows; i++ ) {
            for( int j = 0; j < a.numCols; j++ ) {

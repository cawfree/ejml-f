...
public class GeneratorBlockInnerMultiplication {
    ...
    private void createHeader( boolean hasAlpha , Operation opType , boolean transA , boolean transB )
    {
        ...
        String alphaParam = hasAlpha ? " float alpha ," : "";
        ...
        stream.print(
                "     * </p>\n" +
                "     */\n" +
                "    public static void "+funcName+"("+alphaParam+" final float[] dataA, final float []dataB, final float []dataC,\n" +

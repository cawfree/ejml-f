...
/**
 * <p>
 * Contains triangular solvers for {@link org.ejml.data.BlockMatrix32F} block aligned sub-matrices.
 * </p>
 *
 * <p>
...
public class BlockTriangularSolver {
    ...
    public static void invert( final int blockLength ,
                               final boolean upper ,
                               final D1Submatrix32F T ,
                               final D1Submatrix32F T_inv ,
                               final float temp[] )
    {
        if( upper )
    ...
    public static void solveBlock( final int blockLength ,
                                   final boolean upper , final D1Submatrix32F T ,
                                   final D1Submatrix32F B ,
    ...
    public static void solveL( final int blockLength ,
                               final D1Submatrix32F L,
                               final D1Submatrix32F B ,
                               boolean transL ) {

        D1Submatrix32F Y = new D1Submatrix32F(B.original);

        D1Submatrix32F Linner = new D1Submatrix32F(L.original);
        D1Submatrix32F Binner = new D1Submatrix32F(B.original);
...
//                    Binner.row0 = Binner.row0;
    ...
    public static void solveR( final int blockLength ,
        ...
        D1Submatrix32F Rinner = new D1Submatrix32F(R.original);
        D1Submatrix32F Binner = new D1Submatrix32F(B.original);

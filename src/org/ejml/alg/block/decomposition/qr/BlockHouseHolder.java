 ...
 * Assumptions:
 * <ul>
 *  <le> All submatrices are aligned along the inner blocks of the {@link org.ejml.data.BlockMatrix32F}.
...
public class BlockHouseHolder {
     ...
     */
    public static boolean computeHouseHolderCol( final int blockLength, final D1Submatrix32F Y,
                                                 final float[] gamma, final int i) {
        float max = BlockHouseHolder.findMaxCol(blockLength,Y,i);
     ...
     * @return If there was any problems or not. true = no problem.
     */
    public static boolean computeHouseHolderRow( final int blockLength, final D1Submatrix32F Y,
                                                 final float[] gamma, final int i) {
        float max = BlockHouseHolder.findMaxRow(blockLength,Y,i,i+1);
    ...
    public static void rank1UpdateMultR_Col( final int blockLength ,
                                            final D1Submatrix32F A , final int col , final float gamma )
    {
...
//                plusScale_row(blockLength,);
     ...
     */
    public static float innerProdCol( int blockLength, D1Submatrix32F A,
                                          int colA, int widthA,
                                          int colB, int widthB ) {
        float total = 0;
...
//                    for( int k = 0; k < height; k++ ) {
    ...
    public static void add_row( final int blockLength ,
                                D1Submatrix32F A , int rowA , float alpha ,
                                D1Submatrix32F B , int rowB , float beta ,
                                D1Submatrix32F C , int rowC ,
    ...
    public static void divideElementsCol( final int blockLength ,
                                       final D1Submatrix32F Y , final int col , final float val ) {
     ...
     */
    public static float findMaxCol( final int blockLength , final D1Submatrix32F Y , final int col )
    {
        final int width = Math.min(blockLength,Y.col1-Y.col0);
    ...
    public static void computeW_Column( final int blockLength ,
                                        final D1Submatrix32F Y , final D1Submatrix32F W ,
    ...
    public static void initializeW( final int blockLength,
                                    final D1Submatrix32F W, final D1Submatrix32F Y,
     ...
     * column 'col'.
     */
    public static void computeZ( final int blockLength , final D1Submatrix32F Y , final D1Submatrix32F W,
...
//                for( int k = 0; k < heightW; k++ ,
     ...
     */
    public static void computeY_t_V( final int blockLength , final D1Submatrix32F Y ,
    ...
    public static void multAdd_zeros( final int blockLength ,
                                      final D1Submatrix32F Y , final D1Submatrix32F B ,
                                      final D1Submatrix32F C )
    {
    ...
    public static void multTransA_vecCol( final int blockLength ,
                                          D1Submatrix32F A , D1Submatrix32F B ,
                                          D1Submatrix32F C )
    {

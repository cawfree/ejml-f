...
public class BlockCholeskyOuterSolver implements LinearSolver<BlockMatrix32F> {
    ...
    public void solve(BlockMatrix32F B, BlockMatrix32F X) {
        ...
        D1Submatrix32F L = new D1Submatrix32F(chol.getT(null));
        ...
        // Solve for Y:  L*Y = B
        BlockTriangularSolver.solve(blockLength,false,L,new D1Submatrix32F(B),false);

        // L^T * X = Y
        BlockTriangularSolver.solve(blockLength,false,L,new D1Submatrix32F(B),true);
    ...
    public void invert(BlockMatrix32F A_inv) {
        BlockMatrix32F T = chol.getT(null);
        ...
        D1Submatrix32F L = new D1Submatrix32F(T);
        D1Submatrix32F B = new D1Submatrix32F(A_inv);

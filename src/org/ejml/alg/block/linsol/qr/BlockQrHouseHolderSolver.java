...
/**
 * <p>
 * A solver for {@link org.ejml.alg.block.decomposition.qr.QRDecompositionHouseholder_B32}.  Systems are solved for using the standard
 ...
 * @author Peter Abeles
 */
public class BlockQrHouseHolderSolver implements LinearSolver<BlockMatrix32F> {

    // QR decomposition algorithm
    protected QRDecompositionHouseholder_B32 decomp = new QRDecompositionHouseholder_B32();

    // the input matrix which has been decomposed
    protected BlockMatrix32F QR;
     ...
     */
    @Override
    public boolean setA(BlockMatrix32F A) {
    ...
    @Override
    public void solve(BlockMatrix32F B, BlockMatrix32F X) {
        ...
        BlockTriangularSolver.solve(QR.blockLength,true,
                new D1Submatrix32F(QR,0,M,0,M),new D1Submatrix32F(X),false);
     ...
     */
    @Override
    public void invert(BlockMatrix32F A_inv) {
        int M = Math.min(QR.numRows,QR.numCols);
        ...
        // A^-1 = R^-1*y
        BlockTriangularSolver.solve(QR.blockLength,true,
                new D1Submatrix32F(QR,0,M,0,M),new D1Submatrix32F(A_inv),false);
    }

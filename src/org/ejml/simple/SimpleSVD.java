...
public class SimpleSVD<T extends SimpleMatrix> {
    ...
    private DenseMatrix32F mat;

    public SimpleSVD( DenseMatrix32F mat , boolean compact ) {
        this.mat = mat;
     ...
     */
    public int rank() {
        return SingularOps.rank(svd,10.0f* UtilEjml.EPS);
    }
     ...
     */
    public int nullity() {
        return SingularOps.nullity(svd,10.0f*UtilEjml.EPS);
    }

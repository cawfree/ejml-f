...
/**
 * <p>
 * {@link SimpleMatrix} is a wrapper around {@link org.ejml.data.DenseMatrix32F} that provides an
 ...
 *
 * <p>
 * Working with both {@link org.ejml.data.DenseMatrix32F} and SimpleMatrix in the same code base is easy.
 * To access the internal DenseMatrix32F in a SimpleMatrix simply call {@link SimpleMatrix#getMatrix()}.
 * To turn a DenseMatrix32F into a SimpleMatrix use {@link SimpleMatrix#wrap(org.ejml.data.DenseMatrix32F)}.  Not
...
public class SimpleMatrix extends SimpleBase<SimpleMatrix> {
     ...
     * </p>
     *
     * @see DenseMatrix32F#DenseMatrix64F(int, int, boolean, float...)
     *
    ...
    /**
     * Creates a new SimpleMatrix which is a copy of the DenseMatrix32F.
     *
     * @param orig The original matrix whose value is copied.  Not modified.
     */
    public SimpleMatrix( DenseMatrix32F orig ) {
        this.mat = orig.copy();
    }

    /**
     * Creates a new SimpleMatrix which is a copy of the Matrix32F.
     *
     * @param orig The original matrix whose value is copied.  Not modified.
     */
    public SimpleMatrix( ReshapeMatrix32F orig ) {
        this.mat = new DenseMatrix32F(orig.numRows,orig.numCols);
    ...
    /**
     * Creates a new SimpleMatrix with the specified DenseMatrix32F used as its internal matrix.  This means
     * that the reference is saved and calls made to the returned SimpleMatrix will modify the passed in DenseMatrix32F.
     *
     * @param internalMat The internal DenseMatrix32F of the returned SimpleMatrix. Will be modified.
     */
    public static SimpleMatrix wrap( DenseMatrix32F internalMat ) {
     ...
     * </p>
     *
     * @see org.ejml.ops.CommonOps#diag(float...)
     *
     * @param vals The values of the diagonal elements.
     * @return A diagonal matrix.
     */
    public static SimpleMatrix diag( float ...vals ) {
        DenseMatrix32F m = CommonOps.diag(vals);
     ...
     * </p>
     *
     * @see org.ejml.ops.RandomMatrices#setRandom(DenseMatrix32F,java.util.Random)
     *
     ...
     */
    public static SimpleMatrix random(int numRows, int numCols, float minValue, float maxValue, Random rand) {
...
//     * </p>
//     *
//     * @see CommonOps#mult(DenseMatrix32F, DenseMatrix32F, DenseMatrix32F)
//     * @see CommonOps#multTransA(DenseMatrix32F, DenseMatrix32F, DenseMatrix32F)
//     * @see CommonOps#multTransB(DenseMatrix32F, DenseMatrix32F, DenseMatrix32F)
//     * @see CommonOps#multTransAB(DenseMatrix32F, DenseMatrix32F, DenseMatrix32F)
//     *

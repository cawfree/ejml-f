...
public abstract class SimpleBase <T extends SimpleBase> implements Serializable {
     ...
     * </p>
     *
     * @see org.ejml.ops.CommonOps#transpose(DenseMatrix32F,DenseMatrix32F)
     *
     ...
     * </p>
     *
     * @see CommonOps#mult(org.ejml.data.RowD1Matrix32F , org.ejml.data.RowD1Matrix32F , org.ejml.data.RowD1Matrix32F)
     *
     ...
     * @see CommonOps#kron(DenseMatrix32F, DenseMatrix32F, DenseMatrix32F)
     *
     ...
     * </p>
     *
     * @see CommonOps#subtract(org.ejml.data.D1Matrix32F , org.ejml.data.D1Matrix32F , org.ejml.data.D1Matrix32F)
     *
     * @param b m by n matrix. Not modified.
     *
     * @return The results of this operation.
    ...
    /**
     * <p>
     * Returns the result of matrix-float subtraction:<br>
     * <br>
     * c = a - b <br>
     * <br>
     * where c is the returned matrix, a is this matrix, and b is the passed in float.
     * </p>
     *
     * @see CommonOps#subtract(org.ejml.data.D1Matrix32F , float , org.ejml.data.D1Matrix32F)
     *
     * @param b Value subtracted from each element
     *
     * @return The results of this operation.
     */
    public T minus( float b ) {
        T ret = copy();
     ...
     * </p>
     *
     * @see CommonOps#add( org.ejml.data.D1Matrix32F , float , org.ejml.data.D1Matrix32F)
     *
     * @param beta float value
     *
     * @return A matrix that contains the results.
     */
    public T plus( float beta ) {
     ...
     * </p>
     *
     * @see CommonOps#add( org.ejml.data.D1Matrix32F , float , org.ejml.data.D1Matrix32F , org.ejml.data.D1Matrix32F)
     *
     * @param b m by n matrix. Not modified.
     *
     * @return A matrix that contains the results.
     */
    public T plus( float beta , T b ) {
        T ret = copy();
     ...
     * </p>
     *
     * @see CommonOps#scale(float, org.ejml.data.D1Matrix32F)
     *
     ...
     * </p>
     *
     * @see CommonOps#divide(org.ejml.data.D1Matrix32F,float)
     *
     * @param val Divisor.
     * @return Matrix with its elements divided by the specified value.
     */
    public T divide( float val ) {
        T ret = copy();
     ...
     * </p>
     *
     * @see CommonOps#solve(DenseMatrix32F, DenseMatrix32F, DenseMatrix32F)
     *
     ...
     * </p>
     *
     * @see CommonOps#fill(org.ejml.data.D1Matrix32F , float)
     *
     ...
     * </p>
     *
     * @see org.ejml.ops.NormOps#normF(org.ejml.data.D1Matrix32F)
     *
     ...
     *
     * @see CommonOps#det(DenseMatrix32F)
     *
     * @return The determinant.
     */
    public float determinant() {
        float ret = CommonOps.det(mat);
     ...
     * </p>
     *
     * @see CommonOps#trace(org.ejml.data.RowD1Matrix32F)
     *
     ...
     * </p>
     *
     * @see org.ejml.data.ReshapeMatrix32F#reshape(int,int,boolean)
     *
     ...
     */
    public void setRow( int row , int offset , float ...values ) {
     ...
     * @param values Values which are to be written to the row in a matrix.
     */
    public void setColumn( int column , int offset , float ...values ) {
        for( int i = 0; i < values.length; i++ ) {
     ...
     *
     * @see org.ejml.data.DenseMatrix32F#get(int)
     *
     ...
     *
     * @see org.ejml.data.DenseMatrix32F#getIndex(int, int)
     *
     ...
     * The conversion is done using {@link MatrixIO#print(java.io.PrintStream, org.ejml.data.Matrix32F)}.
     * </p>
     *
     ...
     * </p>
     *
     * @see org.ejml.ops.CommonOps#extractDiag(DenseMatrix32F, DenseMatrix32F)
     ...
     */
    public boolean isIdentical(T a, float tol) {
     ...
     * </p>
     *
     * @see MatrixIO#saveBin( org.ejml.data.ReshapeMatrix32F, String)
     *
     * @param fileName
    ...
    public static SimpleMatrix loadBinary( String fileName )
            throws IOException {
        ReshapeMatrix32F mat = MatrixIO.loadBin(fileName);

        // see if its a DenseMatrix32F
        if( mat instanceof DenseMatrix32F ) {
            return SimpleMatrix.wrap((DenseMatrix32F)mat);
        } else {
            // if not convert it into one and wrap it
            return SimpleMatrix.wrap( new DenseMatrix32F(mat));
        }
    }
    ...
    public static SimpleMatrix loadCSV( String fileName )
            throws IOException {
        ReshapeMatrix32F mat = MatrixIO.loadCSV(fileName);

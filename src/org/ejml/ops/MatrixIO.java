...
public class MatrixIO {
     ...
     */
    public static void saveBin(ReshapeMatrix32F A, String fileName)
        throws IOException
    {
     ...
     * @throws IOException
     */
    public static <T extends ReshapeMatrix32F> T loadBin(String fileName)
        throws IOException
    {
     ...
     * @throws java.io.IOException
     */
    public static void saveCSV( ReshapeMatrix32F A , String fileName )
        throws IOException
    {
     ...
     * @throws IOException
     */
    public static DenseMatrix32F loadCSV( String fileName )
        throws IOException
    {
        FileInputStream fileStream = new FileInputStream(fileName);
        ReadMatrixCsv csv = new ReadMatrixCsv(fileStream);

        DenseMatrix32F ret = csv.read();
     ...
     * @throws IOException
     */
    public static DenseMatrix32F loadCSV( String fileName , int numRows , int numCols )
        throws IOException
    {
        FileInputStream fileStream = new FileInputStream(fileName);
        ReadMatrixCsv csv = new ReadMatrixCsv(fileStream);

        DenseMatrix32F ret = csv.read(numRows,numCols);
    ...
    public static void print( PrintStream out , Matrix32F mat ) {
        print(out,mat,6,3);
    }

    public static void print(PrintStream out, Matrix32F mat , int numChar , int precision ) {
        String format = "%"+numChar+"."+precision+"f ";

        print(out, mat,format);
    }

    public static void print(PrintStream out , Matrix32F mat , String format ) {

        String type = ReshapeMatrix32F.class.isAssignableFrom(mat.getClass()) ? "dense" : "dense fixed";
    ...
    public static void print( PrintStream out , ReshapeMatrix32F mat , String format ,
...
//        DenseMatrix32F A = RandomMatrices.createRandom(50,70,rand);
//

...
public class CovarianceOps {
     ...
     */
    public static boolean isValidFast( DenseMatrix32F cov ) {
     ...
     */
    public static int isValid( DenseMatrix32F cov ) {
     ...
     */
    public static boolean invert( DenseMatrix32F cov ) {
     ...
     * @return true if it could invert the matrix false if it could not.
     */
    public static boolean invert( final DenseMatrix32F cov , final DenseMatrix32F cov_inv ) {
        if( cov.numCols <= 4 ) {
            ...
            LinearSolver<DenseMatrix32F> solver = LinearSolverFactory.symmPosDef(cov.numRows);
     ...
     */
    public static void randomVector( DenseMatrix32F cov ,
                                     DenseMatrix32F vector ,
                                     Random rand  )
    {

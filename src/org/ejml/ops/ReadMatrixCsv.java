...
public class ReadMatrixCsv extends ReadCsv {
    ...
    /**
     * Reads in a DenseMatrix32F from the IO stream.
     * @return DenseMatrix32F
     * @throws IOException If anything goes wrong.
     */
    public DenseMatrix32F read() throws IOException {
    ...
    /**
     * Reads in a DenseMatrix32F from the IO stream where the user specifies the matrix dimensions.
     *
     ...
     * @throws IOException
     */
    public DenseMatrix32F read( int numRows , int numCols ) throws IOException {

        DenseMatrix32F A = new DenseMatrix32F(numRows,numCols);

...
public class ConvertMatrixType {
     ...
     */
    public static void convert( Matrix32F input , Matrix32F output ) {
     ...
     * @param output Output matrix.
     */
    public static void convert( DenseMatrix32F input , BlockMatrix32F output ) {
     ...
     * @return Converted matrix.
     */
    public static DenseMatrix32F convert( BlockMatrix32F input , DenseMatrix32F output ) {

...
public class RandomMatrices {
    ...
    public static DenseMatrix32F[] createSpan( int dimen, int numVectors , Random rand ) {
        if( dimen < numVectors )
            throw new IllegalArgumentException("The number of vectors must be less than or equal to the dimension");

        DenseMatrix32F u[] = new DenseMatrix32F[numVectors];
...
//            System.out.println(" i = "+i);
            DenseMatrix32F a = new DenseMatrix32F(dimen,1);
            DenseMatrix32F r=null;
...
//                UtilEjml.print(a);
     ...
     */
    public static DenseMatrix32F createInSpan( DenseMatrix32F[] span , float min , float max , Random rand ) {
        DenseMatrix32F A = new DenseMatrix32F(span.length,1);

        DenseMatrix32F B = new DenseMatrix32F(span[0].getNumElements(),1);
     ...
     */
    public static DenseMatrix32F createOrthogonal( int numRows , int numCols , Random rand ) {
        if( numRows < numCols ) {
            throw new IllegalArgumentException("The number of rows must be more than or equal to the number of columns");
        }

        DenseMatrix32F u[] = createSpan(numRows,numCols,rand);
     ...
     */
    public static DenseMatrix32F createDiagonal( int N , float min , float max , Random rand ) {
     ...
     * @return A random diagonal matrix.
     */
    public static DenseMatrix32F createDiagonal( int numRows , int numCols , float min , float max , Random rand ) {
        if( max < min )
     ...
     */
    public static DenseMatrix32F createSingularValues(int numRows, int numCols,
                                                      Random rand, float ...sv) {
        DenseMatrix32F U = RandomMatrices.createOrthogonal(numRows,numRows,rand);
        DenseMatrix32F V = RandomMatrices.createOrthogonal(numCols,numCols,rand);

        DenseMatrix32F S = new DenseMatrix32F(numRows,numCols);
        ...
        DenseMatrix32F tmp = new DenseMatrix32F(numRows,numCols);
     ...
     */
    public static DenseMatrix32F createEigenvaluesSymm( int num,  Random rand , float ...eigenvalues ) {
        DenseMatrix32F V = RandomMatrices.createOrthogonal(num,num,rand);
        DenseMatrix32F D = CommonOps.diag(eigenvalues);

        DenseMatrix32F temp = new DenseMatrix32F(num,num);
     ...
     */
    public static DenseMatrix32F createRandom( int numRow , int numCol , Random rand ) {
        DenseMatrix32F mat = new DenseMatrix32F(numRow,numCol);
     ...
     * @param rand Random number generator used to fill the matrix.
     */
    public static void addRandom( DenseMatrix32F A , float min , float max , Random rand ) {
        float d[] = A.getData();
     ...
     * @return The randomly generated matrix.
     */
    public static DenseMatrix32F createRandom( int numRow , int numCol , float min , float max , Random rand ) {
        DenseMatrix32F mat = new DenseMatrix32F(numRow,numCol);
     ...
     * @param rand Random number generator used to fill the matrix.
     */
    public static void setRandom( DenseMatrix32F mat , Random rand )
    {
        setRandom(mat,0,1,rand);
    }
     ...
     * @param rand Random number generator used to fill the matrix.
     */
    public static void setRandom( D1Matrix32F mat , float min , float max , Random rand )
    {
        float d[] = mat.getData();
     ...
     */
    public static DenseMatrix32F createSymmPosDef(int width, Random rand) {
        // This is not formally proven to work.  It just seems to work.
        DenseMatrix32F a = new DenseMatrix32F(width,1);
        DenseMatrix32F b = new DenseMatrix32F(width,width);
     ...
     */
    public static DenseMatrix32F createSymmetric(int length, float min, float max, Random rand) {
        DenseMatrix32F A = new DenseMatrix32F(length,length);
     ...
     * @param rand Random number generator.
     */
    public static void createSymmetric(DenseMatrix32F A, float min, float max, Random rand) {
     ...
     * @return The randomly generated matrix.
     */
    public static DenseMatrix32F createUpperTriangle( int dimen , int hessenberg , float min , float max , Random rand )
    {
        if( hessenberg < 0 )
        ...
        DenseMatrix32F A = new DenseMatrix32F(dimen,dimen);

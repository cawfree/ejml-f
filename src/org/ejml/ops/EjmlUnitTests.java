...
public class EjmlUnitTests {
     ...
     * @param A Matrix
     */
    public static void assertCountable( ReshapeMatrix32F A ) {
     ...
     * @param B Matrix
     */
    public static void assertShape( ReshapeMatrix32F A , ReshapeMatrix32F B ) {
     ...
     */
    public static void assertShape( ReshapeMatrix32F A , int numRows , int numCols ) {
     ...
     * @param tol Tolerance
     */
    public static void assertEqualsUncountable( ReshapeMatrix32F A , ReshapeMatrix32F B , double tol ) {
        assertShape(A,B);
     ...
     * @param tol Tolerance
     */
    public static void assertEquals( ReshapeMatrix32F A , ReshapeMatrix32F B , double tol ) {
        assertShape(A,B);
     ...
     * @param tol Tolerance
     */
    public static void assertEqualsTrans( ReshapeMatrix32F A , ReshapeMatrix32F B , double tol ) {
